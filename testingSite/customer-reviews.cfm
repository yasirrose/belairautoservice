...
@media (max-width: 700px) {
	...
	<!--Services Section-->
        <section class="services-section">
    	        <div class="auto-container">
                        <div class="clearfix">
                                <h3 class="post-title">Customer Reviews</h3>
                                ...
                                <div class="review-thums-icons">
                                    <div class="thum-up-icon">
                                        <a class="success-alert alert-button" data-isgood="true" href="javascript:void(0);"> <img src="images/thumsup-img.png" alt="thumbs up"></a>
                                    ...
                                    <div class="thum-up-icon down">
                                       <a class="danger-alert alert-button" data-isgood="false"  href="javascript:void(0);"> <img src="images/thumsdown-img.png" alt="thumbs down"></a>
                                ...
                                <div class="Review-div">
                                        <div class="Review-Heding">
                                                <h2>From 525 Reviews &nbsp; <img src="Images/stars.png" alt=""></h2>
                                                <img src="" alt="">
                                        </div>
                                </div>
                	</div>
        ...
        <Section class="Review-Sec" id="ReviewSec-id">
                <div class="auto-container">
                    <div class="Review-Main">
                        ...
                        <div class="Review-Box">
                            <div class="Box-data">
                                <img src="Images/Bull-img.png" alt="">
                                <div class="Inner-Data">
                                    <h4>Kevin B.</h4>
                                    <img src="Images/stars.png" alt="">
                                </div>
