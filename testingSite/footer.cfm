    ...
    <footer class="main-footer">
                    	...
                    	<div class="footer-widget contact-widget">
							...
							<!---change requested by Chris Woodie on 04/04/2020 --->
            			 	...
            			 	<!--- -------------------------------------------------------------------- --->
                                ...
                                <li><strong>Website</strong> <a href="https://www.belairautoservice.biz">https://www.belairautoservice.biz</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                    	<div class="footer-widget newsletter-widget">
                            ...
                            <ul class="social-bttn-box">
                            	<li><a href="https://www.facebook.com/Bel-Air-Auto-Service-115837198476058/"><img src="images/Facebook-btn.png" alt="Facebook icon"/></a></li>
        ...
        <div class="footer-bottom">
        	<div class="auto-container">
            	...
            	<div class="row clearfix">
            	    <cfoutput>
                    <div class="col-md-8 col-sm-12 col-xs-12"><div class="copyright">Copryright  &copy;#dateformat(currentyear, "yyyy")# Bel Air Auto Service |  Designed and Built by RuntheBusiness at <a href="http://Runthebusiness.biz" style="color: red;"> RuntheBusiness.biz</a></div>
                    </div></cfoutput>
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <div class="social-links">
                            <a href="https://www.facebook.com/Bel-Air-Auto-Service-115837198476058/" class="fa fa-facebook-f"></a> 
                            <a class="success-alert alert-button thums-icons footer" data-isgood="true" href="javascript:void(0);"> <img src="images/thumsup-img.png" alt="thumbs up"></a>
                            <a class="danger-alert alert-button thums-icons footer" data-isgood="false"  href="javascript:void(0);"> <img src="images/thumsdown-img.png" alt="thumbs down"></a>
...
<script src="//tag.brandcdn.com/autoscript/belairautoservice_vfzstmvvouvuwgc9/belairautoservice.js"></script>
<script>
