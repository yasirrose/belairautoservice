                ...
                <div class="tabs-box clearfix">
                    ...
                    <div class="col-md-8 col-sm-6 col-xs-12 tabs-content clearfix">
                        ...
                        <div class="tab active-tab" id="tab-one">
                            <div class="tab-title">
                                <h3>Automotive Services in Bel Air, Maryland</h3>
                               <h4>We provide all the services you would expect a top notch repair shop to provide. We:</h4>
                            </div>
